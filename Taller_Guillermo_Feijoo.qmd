...
Para comenzar, utiliza OpenStreetMap para identificar todas las amenidades de salud disponibles, como
...
Después de identificar las amenidades de salud, realiza la unión de los polígonos de las zonas censales a
nivel de parroquia
...
Con la información de las parroquias y las amenidades de salud identificadas, realizarás una unión espacial
para determinar cuántas amenidades se encuentran dentro de cada parroquia
...
Se crea histograma para visualizar la distribución del indicador. Esto nos da una idea de cómo están distribuidos estos valores en nuestra base de datos.
